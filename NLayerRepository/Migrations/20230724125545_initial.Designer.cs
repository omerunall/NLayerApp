...
namespace NLayerRepository.Migrations
{
    ...
    [Migration("20230724125545_initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 7, 24, 15, 55, 45, 84, DateTimeKind.Local).AddTicks(252),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 10
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 7, 24, 15, 55, 45, 84, DateTimeKind.Local).AddTicks(337),
                            Name = "Kalem2",
                            Price = 200m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 7, 24, 15, 55, 45, 84, DateTimeKind.Local).AddTicks(341),
                            Name = "Kalem3",
                            Price = 300m,
                            Stock = 30
                        });
